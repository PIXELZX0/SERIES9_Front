...
export const CONTRACTS = {
  ...
  dexRegistry: env.VITE_DEX_REGISTRY_ADDRESS ?? '0x384B5B80127eae59D2a05Dcfd8356d6532bf3fea',
  dexProtocolTreasury: env.VITE_DEX_PROTOCOL_TREASURY_ADDRESS ?? env.VITE_DEX_TREASURY_ADDRESS ?? '0xd45df9f4eB373d0D9A8a9BB1c757EE0e8DA74F66',
  dexOrderbook: env.VITE_DEX_ORDERBOOK_ADDRESS ?? '0x6aEF272265A3aEDb205EdfE09756839ec35CAC88',
  dexSpotPoolFactory: env.VITE_DEX_SPOT_POOL_FACTORY_ADDRESS ?? '0x92e4Ff3F8e911FAFD62a1F341eEA4E5cE5EBBD59',
  dexPerpPoolFactory: env.VITE_DEX_PERP_POOL_FACTORY_ADDRESS ?? '0x67F908CC9c6c2dBE075bd8a442E069647f6522d0',
